...
public class AsyncTestTimes {
	...
	public void updateWith(AsyncTestTimes times) {
		...
		if (times.getServerSendImmediateResponse() >= 0) {
			serverSendImmediateResponse = times.getServerSendImmediateResponse();
		}
		...
		if (times.getServerSendPushNotification() >= 0) {
			serverSendPushNotification = times.getServerSendPushNotification();
		}
